...
impl ThreadLoadStatistics {
    ...
    pub fn new(slots: usize, prefix: &str, thread_loads: Arc<ThreadLoad>) -> Self {
...
mod tests {
    ...
    fn test_thread_load_statistic() {
        ...
        let loads = Arc::new(ThreadLoad::with_threshold(10));
        let l = loads.clone();
        thread::Builder::new()
